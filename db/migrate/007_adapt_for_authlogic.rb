class AdaptForAuthlogic < ActiveRecord::Migration
  def self.up
    add_column :readers, :persistence_token, :string, :null => false, :default => 0
    add_column :readers, :single_access_token, :string, :null => false, :default => 0
    add_column :readers, :perishable_token, :string, :null => false, :default => 0
